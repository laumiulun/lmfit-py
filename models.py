...
from .lineshapes import (breit_wigner, damped_oscillator, dho, donaich,
                         ...
                         split_lorentzian, step, students_t, voigt, shirley)
...
class ShirleyModel(Model):
    ...
    of iterations.This has five Parameters:
    ...
    def guess(self, data, x=None, **kwargs):
        ...
        pars = self.make_params(yr = S_yr, B= S_B)
        return update_param_vals(pars, self.prefix, **kwargs)
